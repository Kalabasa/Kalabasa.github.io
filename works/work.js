(function () {
	...
	page.ready(function () {
		var header = [].concat(toConsumableArray(document.querySelectorAll('header.header'))).pop();	var searchForm = [].concat(toConsumableArray(document.querySelectorAll('#header-search'))).pop();
		...
		searchForm.addEventListener('submit', function (event) {
			...
			if (searchInput.value) {
				var url = '/search.html#' + encodeURIComponent(searchInput.value);
				try {
	...
	var readyCallbacks = window.workPage && window.workPage.readyCallbacks || [];
	...
	page.ready(function () {
		...
		try {
			for (var _iterator = readyCallbacks[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
				var c = _step.value;
		...
		try {
			for (var _iterator2 = document.querySelectorAll('.prose a')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
				var a = _step2.value;
